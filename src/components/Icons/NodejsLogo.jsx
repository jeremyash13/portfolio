...
export default function NodejsLogo({ id }) {
  ...
  return (
    ...
    >
      ...
      <Popover placement="bottom" open={isOpen} target={`#nodejs-logo-${id}`}>
        <PopoverHeader className="popover-header">Node.js</PopoverHeader>
        <PopoverBody className="popover-body">
          As an asynchronous event-driven JavaScript runtime, Node.js is designed to build scalable
          network applications. In Node.js, many connections can be handled concurrently. Upon each

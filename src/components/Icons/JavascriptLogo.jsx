...
export default function JavascriptLogo({ id }) {
  ...
  return (
    ...
    >
      ...
      <Popover placement="bottom" open={isOpen} target={`#js-logo-${id}`}>
        <PopoverHeader className="popover-header">JavaScript</PopoverHeader>

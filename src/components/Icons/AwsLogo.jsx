...
export default function AwsLogo({ id }) {
  ...
  return (
    ...
    >
      ...
      <svg viewBox="-.1 1.1 304.9 179.8" style={someStyles} >
        <path
      ...
      <Popover placement="bottom" open={isOpen} target={`#aws-logo-${id}`}>
        <PopoverHeader className="popover-header">Amazon Web Services</PopoverHeader>
        <PopoverBody className="popover-body">
          Amazon Web Services provides a highly reliable, scalable, low-cost infrastructure platform
          in the cloud that powers hundreds of thousands of businesses in 190 countries around the
          world. With data center locations in the U.S., Europe, Brazil, Singapore, Japan, and
          Australia.
        </PopoverBody>
      </Popover>
    </a>

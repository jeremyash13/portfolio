...
export default function SassLogo({ id }) {
  ...
  return (
    ...
    >
      ...
      <Popover placement="bottom" open={isOpen} target={`#sass-logo-${id}`}>
        <PopoverHeader className="popover-header">Sass (SCSS)</PopoverHeader>
        <PopoverBody className="popover-body">
          Sass is a stylesheet language that’s compiled to CSS. It allows you to use variables,
          nested rules, mixins, functions, and more, all with a fully CSS-compatible syntax. Sass
          helps keep large stylesheets well-organized and makes it easy to share design within and
          across projects.
        </PopoverBody>
      </Popover>
    </a>

...
export default function PhotoshopLogo({ id }) {
  const [isOpen, setIsOpen] = useState(false);
  return (
    <a href="https://www.adobe.com/products/photoshop.html" target="_blank" className="icon">
      <svg
        xmlns="http://www.w3.org/2000/svg"
        viewBox="0 130.746 595.28 580.399"
      ...
      <Popover placement="bottom" open={isOpen} target={`#photoshop-logo-${id}`}>
        <PopoverHeader className="popover-header">Adobe Photoshop</PopoverHeader>
        <PopoverBody className="popover-body">
          ...
          the software has become the industry standard not only in raster graphics editing, but in
